...
mod tests {
    ...
    fn test_decimal_add() {
        ...
        cobolrt_decimal_add(&pd1, &pd2, &mut pd3, false);
        unsafe { assert_eq!(packed_to_i128(&pd3), 300); }
    }
    ...
    fn test_decimal_sub() {
        ...
        cobolrt_decimal_sub(&pd1, &pd2, &mut pd3, false);
        unsafe { assert_eq!(packed_to_i128(&pd3), 300); }
    }
    ...
    fn test_decimal_mul() {
        ...
        cobolrt_decimal_mul(&pd1, &pd2, &mut pd3, false);
        unsafe { assert_eq!(packed_to_i128(&pd3), 120); }
    }
    ...
    fn test_decimal_div() {
        ...
        let ret = cobolrt_decimal_div(&pd1, &pd2, &mut pd3, std::ptr::null_mut(), false);
        assert_eq!(ret, 0);
        unsafe { assert_eq!(packed_to_i128(&pd3), 20); }
    }
